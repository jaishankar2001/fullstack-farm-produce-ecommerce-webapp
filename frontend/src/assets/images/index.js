...
import background_1 from "./background_1.jpeg";
import BannerImage from "./banner-bg.webp";
...
export { Banner, BannerImage, CAT1, CAT2, CAT3, CAT4, CarousalImage, DashboardImage, EmailVerification, FarmCarousal, User, background_1, farm1, logo, BannerImg };
